...
/**
 * help_all - Lists all available built-in Shellby commands
 */
void help_all(void)
{
...
/**
 * help_alias - Presents details about the 'alias' built-in command in Shellby
 */
...
/**
 * help_cd - Provides information about the 'cd' built-in command in Shellby
 */
void help_cd(void)
{
...
/**
 * help_exit - Presents information about the 'exit' built-in command in Shellby
 */
void help_exit(void)
{
...
/**
 * help_help - Offers information about the 'help' built-in command in Shellby
 */
void help_help(void)
{
