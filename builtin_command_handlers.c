...
/**
 * check_builtin - Verifies whether the parsed command is a built-in
...
/**
 * handle_builtin - Manages pre-defined built-in commands
...
/**
 * exit_bul - EExit status for internal commands
 * @cmd: Array of parsed command strings
